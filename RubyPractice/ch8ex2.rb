...
while numberOfBottles > 0 
  puts englishNumber(numberOfBottles) + " bottles of beer on the wall, " + englishNumber(numberOfBottles) + " bottles of beer.
Take one down and pass it around, " + englishNumber(numberOfBottles - 1) + " bottles of beer on the wall."
  numberOfBottles -= 1
end